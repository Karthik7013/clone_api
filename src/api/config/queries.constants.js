...
const UPLOAD_FILE = `INSERT INTO media_files (file_name,file_key,file_url,file_type,mime_type,file_size) VALUES(?,?,?,?,?,?)`;
const DELETE_FILE = `DELETE FROM media_files where file_key = ?`;
const GET_MEDIA_KEY = `SELECT file_url FROM media_files WHERE file_key = ?`;
// errors
